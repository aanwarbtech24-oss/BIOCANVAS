...
import type { Protein, Ligand, DockingPose, LipinskiProfile } from '@/types/api'
...
export interface Step4Props {
  ...
  /** Raw PDB string of the protein receptor (from viewerData in orchestrator) */
  viewerData: string | null
}

// ---------------------------------------------------------------------------
// Step 4 — Results Dashboard (Phase 3: Bento Layout)
// ---------------------------------------------------------------------------

export function Step4_Results({ jobData, selectedProtein, customPdbName, selectedLigand, viewerData }: Step4Props) {
      ...
      <div className="px-5 py-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="rounded-lg bg-surface-highlight/40 px-3 py-2 text-center">
            ...
            <p className="text-[9px] text-muted">&Aring;</p>
          </div>
        </div>
      </div>
    </div>
...
// ---------------------------------------------------------------------------
// AI Analysis Teaser (retained from original — Phase 3B)
// ---------------------------------------------------------------------------
