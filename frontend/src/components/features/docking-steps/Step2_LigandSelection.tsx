...
export interface Step2Props {
  /** Whether Step 1 is complete (for the summary badge) */
  step1Complete: boolean
  /** Step 1 selection details — for the header summary */
  selectedProtein: Protein | null
  customPdbName: string | null
  /** Ligand selection (lifted to parent) */
  selectedLigand: Ligand | null
  setSelectedLigand: (l: Ligand | null) => void
  ligandSmiles: string | null
  setLigandSmiles: (s: string | null) => void
  /** Called when the entire ligand selection is cleared */
  onClear: () => void
}
...
export function Step2_LigandSelection({
  step1Complete,
  selectedProtein,
  customPdbName,
  selectedLigand,
  ...
  const handleClearLigand = useCallback(() => {
    ...
    onClear()
  }, [setSelectedLigand, setLigandSmiles, onClear])
